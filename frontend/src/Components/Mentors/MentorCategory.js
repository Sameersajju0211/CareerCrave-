      ...
      <div className="container">
        <div className="row">
          <div className="col-md-12">
            <h4 className="mb-4">Our Mentors/{products.category}</h4>
          </div>
          {products.mentors.map((product) => (
              ...
              <div className="product-card">
                ...
                <div className="product-card-body">
                  ...
                  <div className="mt-2">
                    ...
                    {product.isAuthor && (
                      <form className="d-inline-block" action={`/products/${product._id}?_method=DELETE`} method="post">
                        <button className="btn btn-danger btn1" type="submit"> <i className="fa fa-trash"></i> Delete</button>
                      </form>
                    )}
                  </div>
                </div>
